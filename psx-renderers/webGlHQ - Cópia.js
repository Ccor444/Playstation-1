...
function WebGLRenderer(canvas) {
  ...
  try {
    // ✨ Configurações Otimizadas para Mobile/Desempenho (WebGL)
    this.gl = canvas.getContext("webgl", {
      ...
      depth: false,
      stencil: false,
      // Prioriza a GPU para WebGL em dispositivos mobile.
      powerPreference: 'high-performance',
      // desynchronized: true, // Mantido comentado para evitar problemas de tela preta.
    });
  }
  catch (e) {
...
WebGLRenderer.prototype.flushVertexBuffer = function (clip) {
  ...
  // Usado gl.STREAM_DRAW: o buffer é re-escrito a cada frame, otimizado para essa situação.
