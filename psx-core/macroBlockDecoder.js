	...
	var mdc = {
		...
		dmaTransferMode0201: function (addr, blck) {
			...
			switch (mdc.r1820 >>> 29) {
				...
				case 0x3:
					// Set Scale Table (IDCT coefficients). Este decoder usa um IDCT
					// AAN de ponto fixo (ver icdt()) com os fatores de escala já
					// embutidos em aanscales[], então os dados da tabela enviada
					// por DMA não precisam ser lidos - só consumimos a transferência
					// normalmente, como o hardware real faria.
					break;
