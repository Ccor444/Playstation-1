...
// ============================================================================
// SHADERS - PS1 NATIVO + MELHORIAS HQ (GLSL ES 3.00)
// ============================================================================

// ------------------------------------------------------------------------
// Vertex Shader de Display (Finalização de Tela) - Versão HQ
// ------------------------------------------------------------------------
...
// ------------------------------------------------------------------------
// Fragment Shader 16bit Display - PS1 nativo com filtro xBR (edge-aware)
// ------------------------------------------------------------------------
...
// Função de detecção de bordas para xBR (luminância)
float getLuminance(vec3 c) {
    return dot(c, vec3(0.299, 0.587, 0.114));
}

// Filtro xBR simplificado (compatível mobile)
...
// ------------------------------------------------------------------------
// Fragment Shader 24bit Display - Otimizado para mobile
// ------------------------------------------------------------------------
...
// ------------------------------------------------------------------------
// Fragment Shader de Desenho - PS1 real com dithering avançado
// ------------------------------------------------------------------------
...
// Matriz de dither 8x8 para melhor qualidade
...
int getDitherValue(ivec2 fc) {
    if (uDitherMode == 0) {
        ...
        // Blue noise approximation (hash-based)
...
function WebGLRenderer(canvas) {
    ...
    // [FIEL] Novos modos de filtro e dithering
    this.filterMode = 0; // 0=nearest, 1=bilinear, 2=xBR
    this.ditherMode = 0; // 0=PS1, 1=8x8, 2=blue noise
...
WebGLRenderer.prototype.initShaders = function () {
    try {
        ...
        gl.uniform1i(this.programDraw.uDitherMode, 0);
        ...
        gl.uniform1i(this.programDisplay.uFilterMode, 0);
...
// ============================================================================
// Novos Métodos de Configuração HQ
// ============================================================================
WebGLRenderer.prototype.setFilterMode = function(mode) {
    ...
    if (this.gl && this.programDisplay) {
        ...
        var loc = this.gl.getUniformLocation(this.programDisplay, "uFilterMode");
        if (loc) {
            this.gl.uniform1i(loc, mode);
        }
    }
};
